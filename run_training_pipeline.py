...
from TrainingInterfaces.TrainingPipelines.ToucanTTS_Hausa import run as madugu
from TrainingInterfaces.TrainingPipelines.ToucanTTS_Swahili import run as tai
